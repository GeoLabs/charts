...
class CustomStacIO(DefaultStacIO):
    ...
    def __init__(self):
        ...
        self.s3_client = self.session.create_client(
            service_name="s3",
            region_name="it-rom",
            endpoint_url="{{ include "argo-workflows.minio.endpoint" . }}",
            aws_access_key_id={{ .Values.minio.auth.rootUser | default "minio-admin" | quote }},
            aws_secret_access_key={{ .Values.minio.auth.rootPassword | default "minio-admin" | quote }},
        )
